...
class NewForgotModal extends Component{
    ...
    render(){
        return (
        <View>
        <Modal isVisible={this.state.isVisible} animationIn='lightSpeedIn' animationOut='fadeOut' backdropTransitionOutTiming={0}>
          <View style={{ }}>
            <View style={{height: '50%', width: '100%', backgroundColor:'white', borderRadius: 10}}>
