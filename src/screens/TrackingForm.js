...
var radio_props = [{ label: "No", value: 0 }, { label: "Yes", value: 1 }];
      ...
      <ScrollView pagingEnabled={true} horizontal={true}>
        ...
        >
          ...
          <RadioForm
            ...
            animation={true}
            onPress={value => {
              this.setState({ mindfulness: value });
            }}
          />
        </View>
        ...
        >
          ...
          <RadioForm
            ...
            animation={true}
            onPress={value => {
              this.setState({ connectedness: value });
            }}
          />
        </View>
        ...
        >
          ...
          >
            Did I log my meals, snacks, and beverages, including alcohol today?
          </Text>
        ...
        <ScrollView>
          ...
          >
            ...
            >
              Here is a graphic of your responses today.
            </Text>
            <ModButton
              label="Show"
            ...
            <View style={{ marginBottom: "50%" }}>
              {this.state.show ? (
                <VictoryChart
                  ...
                  mindfulness={this.state.mindfulness}
                  sleep={this.state.sleep}
                  social={this.state.connectedness}
        ...
        >
          ...
          >
            Your input today will help with your Wellness tomorrow.
          </Text>
